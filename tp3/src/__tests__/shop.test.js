...
describe("shop.js", () => {
  ...
  //   it ("Doit retourner la liste des numéros de téléphone des utilisateurs de plus de 50 ans", () => {
  //     const res = getPhoneNumbers(fakeUsers);
  //     expect(res).toBe(fakeUsers[0].phone);
  //   });
  // });
